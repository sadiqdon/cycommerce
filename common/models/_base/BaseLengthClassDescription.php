<?php
/**
 * This is the model base class for the table "length_class_description".
 * DO NOT MODIFY THIS FILE! It is automatically generated.
 * If any changes are necessary, you must set or override the required
 * property or method in class "LengthClassDescription".
 *
 ...
 */
abstract class BaseLengthClassDescription extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('length_class_id, locale_code, name, unit', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'lengthClass' => array(self::BELONGS_TO, 'LengthClass', 'length_class_id'),
		);
	}
