<?php
/**
 * This is the model base class for the table "product_special".
 * DO NOT MODIFY THIS FILE! It is automatically generated.
 * If any changes are necessary, you must set or override the required
 * property or method in class "ProductSpecial".
 *
 ...
 */
abstract class BaseProductSpecial extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('product_id, c_group_id, priority', 'numerical', 'integerOnly'=>true),
			array('price', 'length', 'max'=>15),
			array('date_start, date_end', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, product_id, c_group_id, priority, price, date_start, date_end', 'safe', 'on'=>'search'),
		);
	}
