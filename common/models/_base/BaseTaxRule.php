<?php
/**
 * This is the model base class for the table "tax_rule".
 * DO NOT MODIFY THIS FILE! It is automatically generated.
 * If any changes are necessary, you must set or override the required
 * property or method in class "TaxRule".
 *
 ...
 */
abstract class BaseTaxRule extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, tax_class_id, tax_rate_id, based, priority', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'cGroups' => array(self::MANY_MANY, 'CGroup', 'tax_rate_c_group(tax_rate_id, c_group_id)'),
		);
	}
