...
abstract class <?php echo $this->baseModelClass; ?> extends <?php echo $this->baseClass; ?> {
	...
	public static function label($n = 1) {
		return Yii::t('app', '<?php echo $this->class2name($modelClass); ?>|<?php echo $this->pluralize($this->class2name($modelClass)); ?>', $n);
	}
...
$relation = substr($relation, 0, strlen($relation)-1). ", 'condition' => 'attributeDescriptions.locale_code = \''.\$localeCode.'\'')";} ?>
