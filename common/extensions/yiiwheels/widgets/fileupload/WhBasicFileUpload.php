...
class WhBasicFileUpload extends CInputWidget
{
    ...
    public function registerClientScript()
    {
        ...
        $cs->registerCssFile($assetsUrl . '/css/jquery.fileupload.css');
		...
		//Included to enable file validation
		$cs->registerScriptFile($assetsUrl . '/js/jquery.fileupload-process.js', CClientScript::POS_END);
		$cs->registerScriptFile($assetsUrl . '/js/jquery.fileupload-validate.js', CClientScript::POS_END);
