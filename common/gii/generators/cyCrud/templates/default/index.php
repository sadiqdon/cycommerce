...
<?php echo "<?php"; ?> $this->beginWidget('yiiwheels.widgets.box.WhBox',
	array(
		'title' => TbHtml::encode('<?php echo $this->pluralize($this->class2name($this->modelClass)); ?>'),
		'headerButtons' => array(
			TbHtml::buttonGroup(
				array(
...
<div id="errorText" class="hide"><?php echo "<?php echo Yii::t('info','An error has occurred'); ?>" ?></div>
<div class="errorTextSort hide"><?php echo "<?php echo Yii::t('info','An error has occurred during sorting'); ?>" ?></div>
