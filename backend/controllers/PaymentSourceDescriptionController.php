...
class PaymentSourceDescriptionController extends CrudController
{
	public $modelName = 'PaymentSourceDescription';
	...
	public function actionCreate() {		
		$model = new PaymentSourceDescription;
				parent::create($model, $this->modelName, 'payment-source-description-form');
			}

	public function actionUpdate($id) {
		$model = $this->loadModel($id, $this->modelName);
				parent::update($id, $this->modelName, 'payment-source-description-form');
			}
	...
	public function actionAdmin() {
		$model = new PaymentSourceDescription('search');
