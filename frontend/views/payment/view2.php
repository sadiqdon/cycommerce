...
<div class="section_body_general">
	<div class="checkout_wrapper">
		<?php 
			if($response['pmt_status'] == 'successful')
		...
		?>
			...
			<h5>Transaction Amount : <?php echo UtilityHelper::formatPrice($response['merch_amt']); ?></h5>
			<h5>Debited Amount : <?php echo UtilityHelper::formatPrice($response['amount']); ?></h5>
