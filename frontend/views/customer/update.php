...
<div class="section_head_general"><?php echo UserModule::t("Update Profile"); ?></div>
...
<?php echo $this->renderPartial('_form_address', array('model'=>$model,'profile'=>$profile,'address'=>$address)); ?>
</div>
</div>